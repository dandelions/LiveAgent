export const ZH_CN_COMMON_TRANSLATIONS = {
  ...
  "chat.searchConversationsPlaceholder": "搜索会话",
  "chat.searchConversationsDescription": "搜索会话标题和历史消息内容。",
  "chat.conversationSearchResults": "搜索结果",
  "chat.pinnedConversations": "置顶会话",
  "chat.noConversationSearchResults": "未找到匹配的会话",
  "chat.conversationSearchFailed": "搜索会话历史失败，请重试。",
  "chat.retryConversationSearch": "重试",
  ...
  "chat.workspaceMountDropSuccess":
    "已将 {count} 个文件夹挂载为附属目录（只读，可在工作空间设置中调整）",
  ...
  "chat.workspaceOr": "或",
  "chat.workspaceOpenFolderSubmit": "选择",
  ...
  "chat.projectPromptTitle": "工作空间提示词",
  "chat.globalPromptTitle": "全局提示词",
  "chat.projectPromptStrategy": "与全局提示词的关系",
  "chat.projectPromptStrategyHint": "选择工作空间提示词如何与当前启用的全局模板组合。",
  "chat.projectPromptAppend": "拼接",
  "chat.projectPromptAppendHint": "先应用当前全局提示词，再追加这个工作空间的专属要求。",
  "chat.projectPromptReplace": "覆盖",
  "chat.projectPromptReplaceHint": "这个工作空间只使用工作空间提示词，不加载全局提示词。",
  "chat.projectPromptContentHint": "留空表示该工作空间仅使用全局提示词。",
  "chat.projectPromptPlaceholder": "输入这个工作空间专属的背景、约束和工作方式...",
  "chat.workspaceSettingsTitle": "工作空间配置",
  "chat.workspaceSettingsNavigation": "工作空间配置导航",
  "chat.workspaceSettingsGeneral": "通用配置",
  "chat.workspaceSettingsDirectories": "目录与权限",
  "chat.workspaceSettingsResources": "资源配置",
  "chat.workspaceSettingsProjectName": "工作空间名称",
  "chat.workspaceSettingsProjectNameRequired": "工作空间名称不能为空。",
  "chat.workspaceSettingsProjectType": "工作空间类型",
  "chat.workspaceSettingsKindManaged": "托管工作空间",
  ...
  "chat.workspaceSettingsDirectoryDuplicate": "该目录已经添加到当前工作空间。",
  "chat.workspaceSettingsResourcesDescription":
    "控制此工作空间会向 Agent 提供哪些 Skills 与 MCP 服务。",
  ...
  "chat.workspacePathDrop.crossProject": "不能引用其他工作空间中的路径",
  ...
  "chat.safety.askDesc": "命令与写入逐条确认，只读操作放行",
  "chat.safety.auto": "自动执行",
  "chat.safety.autoDesc": "按设置的工具权限策略直接执行",
  "chat.safety.sandbox": "沙箱",
  "chat.safety.sandboxDesc": "OS 沙箱执行，写入限项目、敏感目录不可读",
  // Windows 联网后端（受限令牌 WRITE_RESTRICTED）只围栏“写”，读广泛放行 ⇒ 该平台不得
  // 承诺敏感目录不可读；读掩蔽只在断网后端（AppContainer）成立。
  "chat.safety.sandboxDescNoReadMask": "OS 沙箱执行，仅限制写入、本平台不屏蔽读取",
  "chat.safety.sandboxOffline": "沙箱·断网",
  "chat.safety.sandboxOfflineDesc": "沙箱基础上再禁止命令联网",
  ...
  "chat.askUser.sidebarStatus": "请求回答",
  "chat.askUser.tabFallback": "问题",
  "chat.askUser.recommended": "推荐",
  "chat.askUser.customPlaceholder": "输入自定义回答…",
  ...
  "sidebar.continueLoadingHistory": "继续加载会话",
  "chat.pinnedSection": "置顶",
  "chat.workspaceHistoryToggle": "展开/折叠会话",
  "chat.workspaceHistoryRetry": "重试加载会话",
