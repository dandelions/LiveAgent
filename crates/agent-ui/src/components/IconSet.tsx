...
import AccessibilitySource from "~icons/lucide/accessibility";
import ActivitySource from "~icons/lucide/activity";
import AppWindowSource from "~icons/lucide/app-window";
...
import AudioLinesSource from "~icons/lucide/audio-lines";
...
import FingerprintSource from "~icons/lucide/fingerprint";
...
import SquareMousePointerSource from "~icons/lucide/square-mouse-pointer";
...
import VideoSource from "~icons/lucide/video";
...
export const Accessibility = createIcon(AccessibilitySource);
export const Activity = createIcon(ActivitySource);
export const AppWindow = createIcon(AppWindowSource);
export const AudioLines = createIcon(AudioLinesSource);
...
export const Fingerprint = createIcon(FingerprintSource);
...
export const SquareMousePointer = createIcon(SquareMousePointerSource);
...
export const Video = createIcon(VideoSource);
